		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item has-treeview {{ Request::is('admin/product*') ? 'menu-open' : '' }}">
					...
					<!--               class="nav-link {{ Request::is('admin/supplier/create') ? 'active' : '' }}">-->
					<!--                <i class="fa fa-circle-o nav-icon"></i>-->
					<!--                <p>Add Supplier</p>-->
					<!--            </a>-->
					<!--        </li>-->
					...
					<!--				class="nav-link {{ Request::is('admin/employee/create') ? 'active' : '' }}">-->
					<!--				<i class="fa fa-circle-o nav-icon"></i>-->
					<!--				<p>Add Employee</p>-->
					<!--			</a>-->
					<!--		</li>-->
					...
					<ul class="nav nav-treeview">
						<li class="nav-item">
							<a href="{{ route('admin.attendance.create') }}"
								class="nav-link {{ Request::is('admin/attendance/create') ? 'active' : '' }}">
								<i class="fa fa-circle-o nav-icon"></i>
								<p>Take Attendance</p>
							</a>
						</li>
					...
					<ul class="nav nav-treeview">
						<li class="nav-item">
							<a href="{{ route('admin.sales.create') }}"
								class="nav-link {{ Request::is('admin/sales/create') ? 'active' : '' }}">
								<i class="fa fa-circle-o nav-icon"></i>
								<p>Add Sales</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('admin.sales.pending') }}"
								class="nav-link {{ Request::is('admin/sales/create') ? 'active' : '' }}">
								<i class="fa fa-circle-o nav-icon"></i>
								<p>All Sales</p>
							</a>
				...
				<!--    <ul class="nav nav-treeview">-->
				<!--        <li class="nav-item">-->
				<!--            <a href="{{ route('admin.order.installment') }}"-->
				<!--               class="nav-link {{ Request::is('admin/order/installment') ? 'active' : '' }}">-->
				<!--                <i class="fa fa-circle-o nav-icon"></i>-->
				<!--                <p>Installment</p>-->
				<!--            </a>-->
				<!--        </li>-->
				<!--        <li class="nav-item">-->
				<!--            <a href="{{ route('admin.order.full_payment') }}"-->
				<!--               class="nav-link {{ Request::is('admin/order/full-payment') ? 'active' : '' }}">-->
				<!--                <i class="fa fa-circle-o nav-icon"></i>-->
				<!--                <p>Full Payment</p>-->
				<!--            </a>-->
				<!--        </li>-->
				...
				<ul class="nav nav-treeview">
					<li class="nav-item">
						<a href="{{ route('admin.advanced_salary.create') }}"
							class="nav-link {{ Request::is('admin/advanced_salary/create') ? 'active' : '' }}">
							<i class="fa fa-circle-o nav-icon"></i>
							<p>Add Advanced Salary</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="{{ route('admin.advanced_salary.index') }}"
							class="nav-link {{ Request::is('admin/advanced_salary') ? 'active' : '' }}">
							<i class="fa fa-circle-o nav-icon"></i>
