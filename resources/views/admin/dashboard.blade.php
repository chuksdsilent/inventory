                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-info">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{ $today->sum('total') }} Pula</span>

                            @php

                            if ($yesterday->sum('total') != 0)
                            {
                            $percentage = (($today->sum('total') - $yesterday->sum('total'))/
                            $yesterday->sum('total'))*100;
                            } else {
                            $percentage = 0;
                            }
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-info">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{ $month->sum('total') }} Pula</span>
                            @php

                            if ($previous_month->sum('total') != 0)
                            {
                            $percentage = (($month->sum('total') - $previous_month->sum('total'))/
                            $previous_month->sum('total'))*100;
                            } else {
                            $percentage = 0;
                            }
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-info">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{ $year->sum('total') }} Pula</span>
                            @php

                            if($previous_year->sum('total') != 0)
                            {
                            $percentage = (($year->sum('total') - $previous_year->sum('total'))/
                            $previous_year->sum('total'))*100;
                            } else {
                            $percentage = 0;
                            }
                            @endphp
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-info">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number mb-3">{{ $sales->sum('total') }} Pula</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-danger">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{ $month_expenses->sum('amount') }} Pula</span>
                            @php
                            if($yesterday_expenses->sum('amount') != 0)
                            {
                            $percentage = (($today_expenses->sum('amount') - $yesterday_expenses->sum('amount'))/
                            $yesterday_expenses->sum('amount'))*100;
                            } else {
                            $percentage = 0;
                            }
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-danger">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{ $year_expenses->sum('amount') }} Pula</span>
                            @php
                            if($previous_year_expenses->sum('amount') != 0)
                            {
                            $percentage = (($year_expenses->sum('amount') - $previous_year_expenses->sum('amount'))/
                            $previous_year_expenses->sum('amount'))*100;
                            } else {
                            $percentage = 0;
                            }
                            @endphp
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-danger">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number mb-3">{{ $expenses->sum('amount') }} Pula</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-danger">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number mb-3">{{ \App\Product::count() }} </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
